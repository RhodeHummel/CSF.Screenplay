...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "The stage", "  In order to be able to use the passive voice within test\r\n  bindings, I want to" +
                    " be able to refer to actors by names such\r\n  as \'he\' or \'she\'.  This requires a " +
                    "contextual storage of\r\n  an actor.", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Store an actor in the stage", null, ((string[])(null)));
#line 7
