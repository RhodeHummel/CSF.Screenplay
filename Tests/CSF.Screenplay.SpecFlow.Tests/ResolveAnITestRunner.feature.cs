...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("A binding should be able to resolve an ITestRunner", null, ((string[])(null)));
#line 6
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("A binding should be able to subclass the SpecFlow Steps class", null, ((string[])(null)));
#line 11
this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
#line 12
  testRunner.Given("I have an instance of a SpecFlow binding class which derives from the Steps class" +
                    "", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 13
   testRunner.When("I make use of a sample method from that binding class which returns the string \'H" +
                    "ello\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 14
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("It should be possible to execute composite, high-level binding steps", null, ((string[])(null)));
#line 16
this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
#line 17
